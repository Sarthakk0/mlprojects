...
class DataTransformation:
        ...
        try:
            ...
            cat_pipeline = Pipeline(
                steps=[
                    ...
                    ("scalar",StandardScaler(with_mean=False))#If with_mean True, center the data before scaling. 
                    #This does not work (and will raise an exception) when attempted on sparse matrices, 
                    #because centering them entails building a dense 
            ...
            preprocessor = ColumnTransformer(
                [
                    ...
                    ('cate_pipline',cat_pipeline,categorical_columns)
                ]
            )
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            logging.info(
                "Applyin preprocessing object on trainning and testing dataframe"
            )
